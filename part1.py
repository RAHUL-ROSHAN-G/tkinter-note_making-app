...
def create_notes():
    ...
    Label(screen9, text="Please enter a file name for the note below: ").pack()
    Entry(screen9, textvariable=raw_filename).pack()
    Label(screen9, text="Please enter a notes for the file below: ").pack()
...
def delete_note1():
    ...
    Label(screen14, text=str(filename3)+": Removed or deleted from the notes.").pack()
...
def login_sucess():
    ...
    screen3.title("Sucscss")
    screen3.geometry("150x100")
    Label(screen3,text = "Login Sucess").pack()
    Button(screen3,text="OK", command=delete2).pack()
    """

def password_not_recongnised():
    global screen4
    screen4 =Toplevel(screen)
    screen4.title("Sucscss")
...
def register_user():
    ...
    Label(screen1, text = "Registration Successful", font=("Calibri",11)).pack()
...
def login_verify():
    ...
    if username1 in list_of_files:
        ...
        if password1 in verify:
            ...
            password_not_recongnised()
            #print("password has not been recongnised")
    else:
